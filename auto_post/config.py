...
NOTE_THEMES = [
    ...
    "ママワークスで在宅副業を始めた北海道会社員のリアル体験談",
    "在宅副業で月3万円を3ヶ月で達成する具体的な手順",

    # 転職・キャリア（社内SE転職ナビ・strategy career系）
    ...
    "転職活動を3ヶ月で成功させた方法",
    "社内SE転職で残業ゼロになった北海道在住エンジニアの話",
    "ITエンジニアの年収を200万円上げたハイクラス転職の進め方",
    "副業より本業の年収アップが早い理由と転職の始め方",

    # 投資・お金（DMM 株・FPカフェ系）
    "副業で稼いだ最初の3万円を投資に回す具体的な方法",
    "副業の前にFPに無料相談したら家計が月3万円浮いた話",
    "30代会社員が少額投資（NISA・米国株）を始めた1年間の記録",
    "貯金ゼロからお金を増やす「家計見直し→副業→投資」の3ステップ",

    # 在宅環境（auひかり系）
    "在宅副業で稼ぐなら回線速度が命な理由とおすすめ光回線",
    "北海道で在宅ワーク環境を月5,000円以下で整える方法",

    # スキル・資格（合宿免許系）
    "北海道で運転免許を合宿で取った体験談と費用比較",
    "副業の幅を広げる「持ってると得する」資格5選",
